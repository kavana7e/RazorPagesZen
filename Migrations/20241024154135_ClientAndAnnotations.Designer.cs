...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241024154135_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 24, 11, 41, 35, 110, DateTimeKind.Local).AddTicks(1116),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 24, 11, 41, 35, 110, DateTimeKind.Local).AddTicks(1158),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 24, 11, 41, 35, 110, DateTimeKind.Local).AddTicks(1164),
                            ServicesID = 5
                        });
                });
